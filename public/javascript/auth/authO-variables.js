//Declare constants for AuthO details required in app

//Api roles
const API_ROLES = {
  READ_USER_INFO: "read:userInfo",
};
...
// Initialize Auth0 connection with parameters defined above
...
export { API_ROLES, auth0WebAuth, auth0Authentication };
